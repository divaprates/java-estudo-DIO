...
import listas.collections.list.CarrinhoDeCompras;
import listas.collections.list.ListaTarefa;
import listas.collections.list.OrdenacaoPessoa;
import listas.collections.list.SomaNumeros;
import listas.collections.map.Dicionario;
import listas.collections.map.Livraria;
import listas.collections.set.Agenda;
import listas.collections.set.ConjuntoPalavrasUnicas;
